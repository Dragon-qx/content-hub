...
export class AnalyticsService {
  ...
  getAvailableFields() {
    return this.reports.getAvailableFields();
  }
  ...
  generateReport(
    ...
    return this.reports.generateReport(fieldIds, filters, groupBy, sortBy, sortDir, limit);
  }

  saveReport(teamId: string, userId: string, config: ReportConfigDto & { id?: string; name: string }) {
    return this.reports.saveReport(teamId, userId, config);
  }

  listReports(teamId: string) {
    return this.reports.listReports(teamId);
  }
  ...
  deleteReport(reportId: string) {
    return this.reports.deleteReport(reportId);
  }
